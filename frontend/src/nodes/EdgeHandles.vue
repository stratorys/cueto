...
<template>
  <Handle
    ...
    type="source"
    :position="h.position"
    class="cursor-crosshair rounded-md! border-0! bg-transparent! opacity-0 transition-opacity group-hover:opacity-100 group-hover:bg-amber-500/30!"
    :class="[h.size, connecting ? 'opacity-100! bg-amber-500/30!' : '']"
  />
</template>
